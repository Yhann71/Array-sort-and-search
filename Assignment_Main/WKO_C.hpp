...
class Node {
    public:
        ...
        Node(string RID, int age, string transport, int distance, double carbon, int avgDay) {
            ResidentID = RID;
            Age = age;
...
class SinglyLinkedList {
    ...
    void append(string RID, int age, string transport, int distance, double carbon, int avgDay) {
    ...
    // ---------------------------------------------------------------
    void linearSearch(string searchKey, string strTarget, int minInt, int maxInt) {
        Node* current = head;
        int count = 0;
        cout << left
            << setw(14) << "ResidentID"
    ...
    //  Space Complexity : O(1)
    // ---------------------------------------------------------------
    void binarySearch(string searchKey, string strTarget, int minInt, int maxInt) {
        Node* start = head;
        Node* last = nullptr;
